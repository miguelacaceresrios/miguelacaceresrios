...
<!-- spoty y articulos -->
<table align="center" width="90%"><tr valign="middle"><td align="left" width="60%" valign="top" style="padding: 12px;"><div align="left"><h2>Publicaciones y Artículos Destacados</h2><p><i>Análisis técnicos, ensayos y reflexiones sobre ingeniería de software, arquitectura de sistemas e innovación tecnológica.</i></p></div><table align="left" width="100%" cellspacing="0"><tr><td align="left" valign="top" style="padding: 6px 20px 18px 20px;"><h3 style="margin: 0 0 10px 0; font-size: 18px;"><a href="https://www.linkedin.com/pulse/lisp-el-lenguaje-que-sembr%C3%B3-las-ra%C3%ADces-de-la-caceres-rios-ozlme/">✦ LISP: raíces de la IA</a></h3><p style="margin: 0 0 8px 0; line-height: 1.4; font-size: 14px;">Historia y fundamentos de la IA moderna.<br>Un recorrido por el lenguaje que sentó las bases de los sistemas inteligentes actuales.</p></tr></tr><tr><td align="left" valign="top" style="padding: 6px 20px 18px 20px;"><h3 style="margin: 0 0 10px 0; font-size: 18px;"><a href="https://www.linkedin.com/pulse/descubriendo-el-poder-de-wsl-puente-invisible-entre-y-caceres-rios-dzoee/">✦ WSL: Windows + Linux</a></h3><p style="margin: 0 0 8px 0; line-height: 1.4; font-size: 14px;">Desarrollo híbrido sin fricciones.<br>Linux y Windows integrados para un flujo moderno, eficiente y escalable.</p></td></tr><tr><td align="left" valign="top" style="padding: 6px 20px 12px 20px;"><h3 style="margin: 0 0 10px 0; font-size: 18px;"><a href="#">✦ NixOS y la ingeniería de sistemas moderna</a></h3><p style="margin: 0 0 8px 0; line-height: 1.4; font-size: 14px;">Automatización, reproducibilidad y control total del entorno.<br>Una mirada al impacto de NixOS en los flujos de desarrollo modernos.</p></td></tr></table></td><td align="center" width="40%" valign="middle"><a href="https://spotify-github-profile.kittinanx.com/api/view?uid=macaceres0905-co&redirect=true"><img src="https://spotify-github-profile.kittinanx.com/api/view?uid=macaceres0905-co&cover_image=true&theme=apple&show_offline=false&background_color=121212&interchange=false&profanityfalse&mode=dark" width="100%" alt="Spotify Profile" /></a></td></tr></table>
<!--  ------------------------------------------------------------------------------------------------------------------------------------------------------------>
<!-- ====================== EL OJO DE SAURON ====================== -->
<table width="100%">
  <tr>
  ...
  <tr>
    <td width="70%" valign="top">
      ...
      <p>
        ...
        dentro de entornos controlados y autorizados.
      </p>
      <ul>
        <li>Captura y análisis de eventos del sistema</li>
        <li>Arquitectura orientada a investigación forense</li>
        <li>Registro estructurado y procesamiento de telemetría</li>
        <li>Implementación con enfoque ético y educativo</li>
      </ul>
      <p>
        <a href="https://github.com/miguelacaceresrios/ojo-de-sauron">🔗 Ver repositorio</a>
      </p>
    </td>
    <td width="30%" valign="top" align="center">
      <img src="https://placehold.co/350x420?text=SVG+%2F+Stats" width="100%" alt="Project Stats" />
    </td>
  </tr>
</table>
