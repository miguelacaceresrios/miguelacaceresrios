...
<table width="100%">
  <tr>
    <td colspan="2">
      <img src=./assets/sauron.svg width="100%" alt="El Ojo de Sauron Banner" />
    </td>
  </tr>
  <tr>
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td width="65%" valign="top">
      <!-- Banner SVG (ajusta el ancho) -->
      <img src="tu-banner.svg" width="400" alt="Banner">
      <h3>Resumen de comunidad</h3>
      <p>Texto del resumen de comunidad, con descripción breve.</p>
      <h4>Info técnica</h4>
      <p>Detalles técnicos relevantes.</p>
      <h4>Web importante</h4>
      <p><a href="#">Presentación o sitio web</a></p>
      <h4>Proyectos</h4>
      <ul>
        <li>Proyecto 1</li>
        <li>Proyecto 2</li>
    ...
    <td width="35%" align="center" valign="top">
      <!-- Stats con ancho pequeño fijo (200px es pequeño) -->
      <img src="https://gh-stats.com/api/miguelacaceresrios" width="200" alt="GitHub Stats">
    </td>
  </tr>
</table>
